...
JAVA_OPTIONS="-server -XX:-RestrictContended -Xms1096m -Xmx1096m -Doracle.jdbc.diagnostic.enableDiagnoseFirstFailure=false -Doracle.jdbc.diagnostic.enableLogging=false -Doracle.jdbc.diagnostic.enableSensitiveDiagnostics=false -Doracle.jdbc.diagnostic.permitSensitiveDiagnostics=false"
